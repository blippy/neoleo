...
// added by mcarter 23-Feb-2017 as they were used for compilation
// in original sources
#define MEMSTAT
#define EXPORT
...
/* mcarter 23-Feb-2017:
 * the original atl_eval() as supplied by John Walker were defined as
 * 	extern int atl_eval();
 * I don't think that's right, so I have redefined it to what I think
 * it's correct signature should be
 */
